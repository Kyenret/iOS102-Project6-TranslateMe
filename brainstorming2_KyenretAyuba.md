...
+ Use OpenWeatherAPI to display weather information (temperature, location, wind speed, etc.)
+ Add forecast to next 10 days
+ Display temperature map in the chosen area
